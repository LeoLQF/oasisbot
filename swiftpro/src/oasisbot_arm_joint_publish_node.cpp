...
#include </home/lqf/catkin_ws/devel/include/swiftpro/SwiftproState.h>
...
{
	ros::init(argc, argv, "oasisbot_arm_joint_publish_node");
	ros::NodeHandle n;
	...
	while (ros::ok())
	{
		...
		// base_link.transform.rotation = tf::createQuaternionMsgFromYaw(10);
		//
